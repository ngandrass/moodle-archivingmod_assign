...
$string['task_report_section_annotatedpdfs'] = 'Annotated PDF files';
$string['task_report_section_annotatedpdfs_help'] = 'Include PDF files that were annotated by the grader. This does not include additional files that were uploaded by the grader.';
...
$string['task_report_section_feedbackfiles'] = 'Feedback files';
$string['task_report_section_feedbackfiles_help'] = 'Include feedback files uploaded by the grader. This does not include PDFs that were annotated by the grader within Moodle.';
...
$string['task_report_section_introfiles'] = 'Intro files';
$string['task_report_section_introfiles_help'] = 'Include files attached to the assignment introduction. These are files that are given alongside the assignment instructions and were provuded by the assignment creator.';
...
$string['task_report_section_submissionfiles'] = 'Submission files';
$string['task_report_section_submissionfiles_help'] = 'Include files submitted by the student during the submission.';
